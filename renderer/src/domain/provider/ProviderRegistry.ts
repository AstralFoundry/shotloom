 ...
 * 模型通过 provider-catalog.json 的 Adapter / Binding 归属路由到对应凭据。
 */

import type { ProviderModelBinding } from "./ProviderAdapterContract";
  ...
  },
  {
    ...
    credentials: [
      KEY_FIELD,
      {
        ...
        label: "工作空间地址",
        required: true,
        placeholder: "https://{WorkspaceId}.ap-southeast-1.maas.aliyuncs.com",
      },
    ],
  },
  {
